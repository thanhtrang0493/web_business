...
riot.tag2('product-customiser', '<main class="items-stretch"> <div class="wrapper-down"> <div id="column-1"> <sidebar options="{state.options}" activelayers="{state.activeLayers}"></sidebar> </div> <div id="column-2"> <changing-room activelayers="{state.activeLayers}" class="flex justify-center"></changing-room> </div> </div> </main>', '', '', function (opts) {
   var _this = this;
...
riot.tag2('colour', '<div class="colour mr-4 {isActive: isActive}" riot-style="{styles}" onclick="{changeLayer}"></div>', '', '', function (opts) {
   ...
   if (this.thumbnail !== '') {
       this.styles = {
           'background': 'url(image/thumbs/' + this.thumbnail + '.png) no-repeat 50% 50% / cover'
       };
   } else {
       this.styles = {
...
var riot = __webpack_require__(0);
riot.tag2('changing-room', '<div class="layer-wrap"> <img src="image/layers/base.png" alt="Naked Dave" class="base-layer"> <img class="layer" riot-src="{this.legLayer}"> <img class="layer" riot-src="{this.torsoLayer}"> <img class="layer" riot-src="{this.headLayer}"> </div>', '', '', function (opts) {
   var _this = this;

   var base = 'image/layers';
